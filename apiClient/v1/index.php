...
mail($to,$subject,$message, $headers);
                    ...
                    $query = mysqli_query($conectar, "UPDATE generalCustomers SET ecmCode='0' codeAttemps=(SELECT codeAttemps FROM generalCustomers WHERE customerMail='$customerMail' AND clientId='$clientId')+1 where clientId='$clientId' and customerMail='$customerMail'");
